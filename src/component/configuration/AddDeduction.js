...
const AddDeduction = (props) => {
    ...
    const updateIndex = props.getUpdateIndex();
    const lastIndex = updateIndex!=null?updateIndex:props.lastIndex+1;
    //const lastIndex = 0;
    ...
    return <>
        ...
        <Modal show={show} onHide={handleClose} >
            <Modal.Header closeButton>
                <Modal.Title>{updateIndex!=null?'Update Deduction':'Add Deduction'}</Modal.Title>
            </Modal.Header>
            <Modal.Body>
